...
export class AppointmentService {
  ...
  static async getAppointmentsForConfirmation() {
  ...
  static async getAppointmentDetails(data: { appointmentId: string }) {
  ...
  static async create(data: {
    ...
    if (!patientId || !procedureId || !appointmentDateTime)
      throw new Error(
        `${ERROR_CODES.VALIDATION_ERROR}: ${ERROR_MESSAGES.VALIDATION_ERROR}`,
      );
    ...
    if (isDayBooked) {
      throw new Error(
        `${ERROR_CODES.APPOINTMENT_EXISTS_ERROR}: ${ERROR_MESSAGES.APPOINTMENT_EXISTS_ERROR}`,
      );
    }
  ...
  static async update(data: {
    ...
    if (!appointmentId || !patientId || !procedureId || !appointmentDateTime)
      throw new Error(
        `${ERROR_CODES.VALIDATION_ERROR}: ${ERROR_MESSAGES.VALIDATION_ERROR}`,
      );
  ...
  static async assignProcedurePrice(data: {
    ...
    if (!appointmentId || !procedurePrice)
      throw new Error(
        `${ERROR_CODES.VALIDATION_ERROR}: ${ERROR_MESSAGES.VALIDATION_ERROR}`,
      );
    ...
    if (!requestingUser || requestingUser.role !== "ADMIN") {
      throw new Error(
        `${ERROR_CODES.FORBIDDEN_ERROR}: ${ERROR_MESSAGES.FORBIDDEN_ERROR}`,
      );
    }
    ...
    if (currentAppointment.appointmentStatus === "SCHEDULED") {
      throw new Error(
        `${ERROR_CODES.VALIDATION_ERROR}: Cannot assign a procedure price to a scheduled appointment. Please confirm the appointment first.`,
      );
    }
  ...
  static async completeAppointment(data: {
    ...
    if (!appointmentId || !amountReceived)
      throw new Error(
        `${ERROR_CODES.VALIDATION_ERROR}: ${ERROR_MESSAGES.VALIDATION_ERROR}`,
      );
    ...
    if (currentAppointment.appointmentStatus === "SCHEDULED") {
      throw new Error(
        `${ERROR_CODES.VALIDATION_ERROR}: Cannot complete a scheduled appointment. Please confirm the appointment first.`,
      );
    }
