...
export function VerifyEmailContent() {
  ...
  return (
    <Card className="relative overflow-hidden w-full max-w-md mx-auto p-6 sm:p-8 rounded-2xl border border-slate-200/80 shadow-md bg-white text-center transition-all">
      <HeaderTitle />
        ...
        {isLoading && (
          <div className="py-6 flex flex-col items-center">
            <Loader2
              ...
              style={{ color: DENTAL_PALETTE.primary.DEFAULT }}
            />
        ...
        {isSuccess && (
          <div className="py-2 flex flex-col items-center">
            ...
            <p className="text-sm text-slate-600 mb-6 leading-relaxed">
              ...
              your account and manage appointments.
            </p>
            <Link
              href={UI_ROUTES.AUTH.LOGIN}
              style={{ backgroundColor: DENTAL_PALETTE.primary.DEFAULT }}
              className="w-full inline-flex items-center justify-center gap-2 text-white font-medium py-3 px-4 rounded-xl shadow-sm hover:opacity-90 transition-all text-sm"
            >
